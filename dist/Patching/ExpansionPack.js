...
function patchOutSpeedupCodes() {
    ...
    if (IodineGUI.Iodine.IOCore.cartridge.cartriges.get("FR")) {
        ...
        // KITTY? Why is this even a thing.... Sssh we don't talk about it...
        if (patchoutCountEven) {
            patchSectionOfRom(0x8d0, [0x14,0x17,0x03,0x02,0x01,0x49,0x08,0x62,0x70,0x47,0x00,0x00,0xf0,0x30,0x00,0x03] , "FR");
        } else {
            patchSectionOfRom(0x8d0, [0xae,0xf3,0x03,0x02,0x01,0x49,0x08,0x62,0x70,0x47,0x00,0x00,0xf0,0x30,0x00,0x03] , "FR");
        }
        patchoutCountEven = !patchoutCountEven;
