...
function patchGameIssues() {
    if(IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C")) {
        ...
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x227f27, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x227f28, 0x00); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x227f29, 0x00); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x227f3E, 0x9c); 
 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228184, 0x9c);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228186, 0x01); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2281b4, 0x00); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2281b5, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2281b6, 0x00);  
 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228422, 0x9c);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228424, 0x02); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228452, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228453, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x228454, 0x00);  
        
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2286ac, 0x9c);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2286ae, 0x03); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2286dc, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2286dd, 0x00);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x2286de, 0x00); 

        // Keep All the crystal doors open
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf150da, 0x0e); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf150f4, 0x16);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf150f5, 0x32);

        patchSectionOfRom(0xf152a2, [0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x08,0x06,0x79,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf152b0, [0x79,0x30,0x08,0x06,0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf152c0, [0x81,0x30,0x81,0x30,0x81,0x30,0x88,0x30,0x89,0x30,0x8a,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf152d0, [0x81,0x30,0x81,0x30,0x81,0x30,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04] , "C");
        patchSectionOfRom(0xf152e0, [0x1a,0x04,0x1b,0x04,0x1c,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04] , "C");

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf64f5a, 0x0e); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf64f74, 0x16);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf64f75, 0x32);

        patchSectionOfRom(0xf65122, [0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x08,0x06,0x79,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf65130, [0x79,0x30,0x08,0x06,0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf65140, [0x81,0x30,0x81,0x30,0x81,0x30,0x88,0x30,0x89,0x30,0x8a,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf65150, [0x81,0x30,0x81,0x30,0x81,0x30,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04] , "C");
        patchSectionOfRom(0xf65160, [0x1a,0x04,0x1b,0x04,0x1c,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04] , "C");

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf65196, 0x0e); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf651b0, 0x16);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf651b1, 0x32);

        patchSectionOfRom(0xf6535E, [0x79,0x30] , "C");
        patchSectionOfRom(0xf65360, [0x79,0x30,0x79,0x30,0x79,0x30,0x08,0x06,0x79,0x30,0x81,0x30,0x79,0x30,0x08,0x06] , "C");
        patchSectionOfRom(0xf65370, [0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x81,0x30,0x81,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf65380, [0x81,0x30,0x88,0x30,0x89,0x30,0x8a,0x30,0x81,0x30,0x81,0x30,0x81,0x30,0x81,0x30] , "C");
        patchSectionOfRom(0xf65390, [0x81,0x30,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x1a,0x04,0x1b,0x04] , "C");
        patchSectionOfRom(0xf653a0, [0x1c,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x08,0x04,0x03,0x07] , "C");

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf65e0e, 0x0e); 
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf65e28, 0x16);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf65e29, 0x32);

        patchSectionOfRom(0xf65fd6, [0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30,0x08,0x06] , "C");
        patchSectionOfRom(0xf65fe0, [0x79,0x30,0x81,0x30,0x79,0x30,0x08,0x06,0x79,0x30,0x79,0x30,0x79,0x30,0x79,0x30] , "C");
        patchSectionOfRom(0xf65ff0, [0x81,0x30,0x81,0x30,0x81,0x30,0x81,0x30,0x81,0x30,0x88,0x30,0x89,0x30,0x8a,0x30] , "C");
        ...
        patchSectionOfRom(0x533710, [0xcb,0xd0,0x9e,0x08] , "C");

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x533767, 0x08);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x53376b, 0x08);

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x9ed0d4, 0x70);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x9ed0d5, 0x77);

        patchSectionOfRom(0xf0ca81, [0x00,0xff,0xff,0xff,0xff,0xff] , "C");

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0xf656de, 0x16);
        ...
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x4840ee, 0xFF);

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x484107, 0x04);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x48410A, 0xFF);

        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x484123, 0x04);
        IodineGUI.Iodine.IOCore.cartridge.cartriges.get("C").patchROM8(0x484126, 0xFF);
