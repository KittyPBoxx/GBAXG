...
class RomPatcher {
    ...
    */
    ...
    patchEmerald(textUpdateFunction) {
        ...
        // Allow bike in any map (to prevent getting stuck on bike)
        this.patchROM8(0x8548C, 0x01); 
        this.patchROM8(0x899f0, 0x01);
        this.patchROM8(0x119f42, 0x00);
    ...
    patchCrystal(textUpdateFunction) {
        ...
        // Fix morty's gym
        this.patchROM8(0xe512d4, 0x02);
        this.patchROM8(0xe512d6, 0x05);

        this.patchROM8(0xe512dc, 0x03);
        this.patchROM8(0xe512de, 0x06);
